...
//IMPLEMENT_SERIAL(CElement, notCObject, 0)
...
void CElement::SetGuid()
{
	...
	string objectId;
	objectId = "guid_%d_%s_%03d_%ld", m_counter, "%H%M%S", st.wMilliseconds, GetTickCount();
...
void CElement::SetName()
{
	...
	CTime dt = CTime::GetCurrentTime();
	string name; 
	name = "Element n_%d", CFactory::g_counter; //_%s.%03d", dt.Format("%H%M%S"), tm.wMilliseconds);
	//this->m_name = name;
}
...
//	if (ar.IsStoring())
//	{
//		string name = W2T((LPTSTR)m_name.c_str());
//		ar << name;
//		int type = m_type;
//		ar << type;
//		int shapeType = m_shapeType;
//		ar << shapeType;
//		string objectId = W2T((LPTSTR)m_objectId.c_str());
//		ar << objectId;
//		string caption = W2T((LPTSTR)m_caption.c_str());
//		ar << caption;
//		string text = W2T((LPTSTR)m_text.c_str());
//		ar << text;
//		ar << m_rect;
//		ar << m_point;
//		ar << m_last;
...
//		ar << m_bColorLine;
//		ar << m_lineWidth;
//		string image = W2T((LPTSTR)m_image.c_str());
//		ar << image;
//	}
//	else
//	{
...
string CElement::ToString()
{
	string str;
	str = "Element name=<%s> id={%s} type=<%s> shape=<%s> rect={%d,%d,%d,%d} caption=<%s> text=<%s> image=<%s> colorFill={%03d%03d%03d} colorLine={%03d%03d%03d}",
...
string CElement::ToString(ElementType type)
{
	string str = "";
	switch(type)
	{
		case ElementType::type_unknown:
			str = "type_unknown->not implemented yet";
			break;

		case ElementType::type_shapes_simple:
			str = "type_shapes_simple";
			break;
		...
		case ElementType::type_shapes_infrastructure:
			str = "type_shapes_infrastructure";
			break;
...
string CElement::ToString(ShapeType type)
{
	string str = "";
	switch(type)
	{
		...
		case infrastructure_server_ad:
			str = "infrastructure_server_ad";
			break;
		case infrastructure_server:
			str = "infrastructure_server";
			break;
		case infrastructure_server_web:
			str = "infrastructure_server_web";
			break;
		case infrastructure_server_database:
			str = "infrastructure_server_web";
			break;
		case infrastructure_workstation:
			str = "infrastructure_workstation";
			break;
		case infrastructure_laptop:
			str = "infrastructure_laptop";
			break;
		case infrastructure_firewall:
			str = "infrastructure_firewall";
			break;
		case infrastructure_network:
			str = "infrastructure_network";
			break;
		case infrastructure_virtual_server:
			str = "infrastructure_virtual_server";
			break;
		case infrastructure_virtual_server_web:
			str = "infrastructure_virtual_server_web";
			break;
		case infrastructure_virtual_server_database:
			str = "infrastructure_virtual_server_database";
			break;
		case infrastructure_virtualization_server:
			str = "infrastructure_virtualization_server";
			break;
		case infrastructure_server_ad_grey:
			str = "infrastructure_server_ad";
			break;
		case infrastructure_server_grey:
			...
			break;
		case infrastructure_server_database_grey:
			str = "infrastructure_server_database";
			break;
		case infrastructure_server_farm:
			str = "infrastructure_server_farm";
			break;
		case infrastructure_workstation_grey:
			str = "infrastructure_workstation";
			break;
		...
		case development_class:
			str = "development_class";
			break;
		case development_interface:
			str = "development_interface";
			break;
		case development_enumeration:
			str = "development_enumeration";
			break;
		case development_package:
			str = "development_package";
			break;
		case development_comment:
			str = "development_comment";
			break;
		case development_association:
			str = "development_association";
			break;
		case development_aggregation:
			str = "development_aggregation";
			break;
		case development_composition:
			str = "development_composition";
			break;
		case development_dependency:
			str = "development_dependency";
			break;
		case development_inheritance:
			str = "development_inheritance";
			break;
		case development_package_import:
			str = "development_package_import";
			break;
		case development_connector:
			str = "development_connector";
			break;
		case development_component:
			str = "development_component";
			break;
	}
	return str;
}
...
int CElement::HitTest(CPoint point, CModeler1View* pView, bool bSelected)
{
	...
	if (bSelected)
	{
		...
		for (int nHandle = 1; nHandle <= nHandleCount; nHandle += 1)
		{
			...
			// Debugging
			//str.Format("HitTest try point{%d,%d} in rect{%d,%d,%d,%d}"), point.x, point.y, rc.left, rc.top, rc.right, rc.bottom);
			//pView->LogDebug(str);
...
void CElement::Draw(CModeler1View * pView, CDC* pDC)
{
  ...
  // 
		...
		//else
		{
			...
			//graphics.DrawString(stringW(str), -1, &font, PointF(pointText.x, pointText.y), &solidBrush);
		}
	}
	...
	//		graphics.SetTextRenderingHint(TextRenderingHintAntiAlias);
	//		graphics.DrawString(stringW(m_text), -1, &font, rectF, &stringFormat, &solidBrush);
	//	}
	//}
	//else
	//{
	...
	//		SolidBrush solidBrush(Color(255, 0, 0, 0));
	//		graphics.SetTextRenderingHint(TextRenderingHintAntiAlias);
	//		//graphics.DrawString(string(m_text.c_str()), -1, &font, PointF(pointText.x, pointText.y), &solidBrush);
	//	}
	//}
